  ...
  return (
    <div className="relative isolate flex min-h-dvh flex-col overflow-x-clip">
      ...
      <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.025)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.025)_1px,transparent_1px)] bg-[size:48px_48px] [mask-image:radial-gradient(ellipse_70%_55%_at_50%_0%,black,transparent)]" />
      </div>

      <main
        id="main"
        className="mx-auto w-full max-w-[640px] flex-1 px-5 pb-16 pt-16 sm:pt-24"
      >
        {children}
      </main>
